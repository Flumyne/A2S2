...
class FourierEmbedding(nn.Module):
    ...
    """
    def __init__(self, in_features, n_freq=6):
        super().__init__()
...
class NeuralNet(nn.Module):
    ...
    """
    def __init__(self, input_dim=2, hidden_dim=64, output_dim=2, num_layers=5, use_fourier=True):
        super(NeuralNet, self).__init__()
        
        self.use_fourier = use_fourier
        if use_fourier:
            self.embedding = FourierEmbedding(input_dim, n_freq=6)
